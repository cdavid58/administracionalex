...
from user.models import User, Multimedia
	...
	data = [
		{
			...
			'street':i.street,
			'agent_photo': url_photo+str(Multimedia.objects.get(user = i.user).photo.url),
...
def Create_Reservation(request):
	...
	Reservation(
		...
		propertys = Property.objects.get(pk = data['propertys']),
		propietrio = User.objects.get(pk = data['pk_user']),
		boys = data['boys'],
		adult = data['adult'],
		price = data['price'],
